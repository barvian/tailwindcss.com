...
```html {{ example: { p: 'none' } }}
<div class="~/sm:~px-4/0">
  <article class="mx-auto max-w-sm bg-white p-8 ~/sm:~text-sm/base ~/sm:~leading-6/7 text-slate-700 shadow-xl dark:bg-slate-800 dark:text-slate-400">
...
```html {{ example: { p: 'none' } }}
<div class="~/sm:~px-4/0">
  <div class="mx-auto max-w-sm bg-white p-8 ~/sm:~text-sm/base ~/sm:~leading-6/7 text-slate-700 shadow-xl dark:bg-slate-800 dark:text-slate-400">
