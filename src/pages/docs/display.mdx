...
```html {{ example: { p: 'none' } }}
<div class="mx-auto max-w-xs bg-white shadow-xl p-4 text-slate-500 ~/sm:~text-sm/base ~/sm:~leading-6/7 dark:bg-slate-800 dark:text-slate-400">
...
```html {{ example: { p: 'none' } }}
<p class="mx-auto max-w-lg bg-white shadow-xl p-4 text-slate-500 ~/sm:~text-sm/base ~/sm:~leading-6/7 dark:bg-slate-800 dark:text-slate-400">
