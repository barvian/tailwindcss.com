...
<div class="overflow-hidden relative max-w-md mx-auto bg-white shadow-lg ring-1 ring-black/5 rounded-xl flex items-center gap-6 dark:bg-slate-800 dark:highlight-white/5">
  ...
  <div class="min-w-0 py-5 pl-28 pr-5">
    <div class="text-slate-900 font-medium ~/sm:~text-sm/base truncate dark:text-slate-200">Andrew Alfred</div>
    <div class="text-slate-500 ~/sm:~text-sm/base leading-tight truncate dark:text-slate-400">Assistant to the Traveling Secretary</div>
  </div>
</div>
```
