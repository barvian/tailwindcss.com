...
```html {{ example: { p: 'none' } }}
<div class="bg-white p-8 shadow-xl text-slate-700 max-w-md mx-auto overflow-auto ~/sm:~text-sm/base ~/sm:~leading-6/7 dark:bg-slate-800 dark:text-slate-400">
...
```html {{ example: { p: 'none' } }}
<div class="bg-white px-6 py-8 shadow-xl text-slate-700 max-w-md mx-auto overflow-auto ~/sm:~text-sm/base ~/sm:~leading-6/7 dark:bg-slate-800 dark:text-slate-400">
